...
### 3.3 視覺化觀察
### 3.3 視覺化觀察 (Visual Analysis)
我們透過五張圖表來深入剖析模型的表現與資料的特性：
...
#### 3. 天花板效應：房價分佈
![Distribution](https://ithelp.ithome.com.tw/upload/images/20251210/20161788TWJ5C8U9eU.jpg)
* **觀察：** 這是本資料集最著名的陷阱。在直方圖最右側 **5.0 ($500k)** 的位置，有一根異常突出的柱子。
* **結論：** 這證實了當年普查時，將所有超過 50 萬美元的房價都直接標記為 50 萬。這就是 **「右尾截斷 (Right-Censored)」**，它會誤導線性回歸去擬合一條不真實的直線。

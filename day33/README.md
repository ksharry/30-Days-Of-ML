...
> 1.  **剛開始 (Epoch 1)**：$G$ 像個**剛拿筆的嬰兒**，只會亂塗鴉。$D$ 也是個**瞎子警察**，分不出真假。
> 2.  **過一陣子 (Epoch 10)**：$G$ 發現「只要塗黑黑的一團」警察就會說是真的，所以它開始畫黑團塊。
> 3.  **最後 (Epoch 50)**：$D$ 變成了**神探**，只要筆畫歪一點就抓。$G$ 被逼得只好練成**書法大師**，畫出完美的數字來騙過神探。

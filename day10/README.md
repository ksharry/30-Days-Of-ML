...
#### 現實的妥協：軟間隔 (Soft Margin)
但在真實世界中，資料通常沒那麼完美 (可能有雜訊或重疊)。如果硬要畫一條「完全沒錯」的線 (Hard Margin)，這條馬路可能會變得很窄，甚至畫不出來。
*   **解決方案**：允許少數幾個點「違規」跑到馬路上，換取一條更寬、更穩定的馬路。
*   這就是 **Soft Margin** 的概念，而參數 **C** 就是用來控制「我們能容忍多少違規」的開關。
